...
ndvi050316.1.9 <- crop(ndvi050316, extent(ndvi050316, 1, 79, 1601, 1800))
ndvi052616.1.9 <- crop(ndvi052616, extent(ndvi052616, 1, 79, 1601, 1800))
ndvi062316.1.9 <- crop(ndvi062316, extent(ndvi062316, 1, 79, 1601, 1800))
ndvi062916.1.9 <- crop(ndvi062916, extent(ndvi062916, 1, 79, 1601, 1800))
ndvi072716.1.9 <- crop(ndvi072716, extent(ndvi072716, 1, 79, 1601, 1800))
ndvi081716.1.9 <- crop(ndvi081716, extent(ndvi081716, 1, 79, 1601, 1800))
ndvi082416.1.9 <- crop(ndvi082416, extent(ndvi082416, 1, 79, 1601, 1800))
...
ndvi050316.1.9.p <- ndvi050316.1.9.p + labs(title = "Rush Ranch Block 1, Section 9.1\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.1.9.p
...
ndvi052616.1.9.p <- ndvi052616.1.9.p + labs(title = "Rush Ranch Block 1, Section 9.1\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.1.9.p
...
ndvi062316.1.9.p <- ndvi062316.1.9.p + labs(title = "Rush Ranch Block 1, Section 9.1\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.1.9.p
...
ndvi062916.1.9.p <- ndvi062916.1.9.p + labs(title = "Rush Ranch Block 1, Section 9.1\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.1.9.p
...
ndvi072716.1.9.p <- ndvi072716.1.9.p + labs(title = "Rush Ranch Block 1, Section 9.1\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.1.9.p
...
ndvi081716.1.9.p <- ndvi081716.1.9.p + labs(title = "Rush Ranch Block 1, Section 9.1\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.1.9.p
...
ndvi082416.1.9.p <- ndvi082416.1.9.p + labs(title = "Rush Ranch Block 1, Section 9.1\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.1.9.p
ggsave(file = "082416.9.1.png")

set.seed(131)
ndvi050316.1.9.us <- na.omit(ndvi050316.1.9.us); ndvi050316.1.9.rs <- sample_n(ndvi050316.1.9.us, 3800); ndvi050316.1.9.rs$Date <- "a"
ndvi052616.1.9.us <- na.omit(ndvi052616.1.9.us); ndvi052616.1.9.rs <- sample_n(ndvi052616.1.9.us, 3800); ndvi052616.1.9.rs$Date <- "b"
ndvi062316.1.9.us <- na.omit(ndvi062316.1.9.us); ndvi062316.1.9.rs <- sample_n(ndvi062316.1.9.us, 3800); ndvi062316.1.9.rs$Date <- "c"
ndvi062916.1.9.us <- na.omit(ndvi062916.1.9.us); ndvi062916.1.9.rs <- sample_n(ndvi062916.1.9.us, 3800); ndvi062916.1.9.rs$Date <- "d"
ndvi072716.1.9.us <- na.omit(ndvi072716.1.9.us); ndvi072716.1.9.rs <- sample_n(ndvi072716.1.9.us, 3800); ndvi072716.1.9.rs$Date <- "e"
ndvi081716.1.9.us <- na.omit(ndvi081716.1.9.us); ndvi081716.1.9.rs <- sample_n(ndvi081716.1.9.us, 3800); ndvi081716.1.9.rs$Date <- "f"
ndvi082416.1.9.us <- na.omit(ndvi082416.1.9.us); ndvi082416.1.9.rs <- sample_n(ndvi082416.1.9.us, 3800); ndvi082416.1.9.rs$Date <- "g"
...
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 9.1\n2016 NDVI Values")
rrblrsp
...
ndvi050316.2.9 <- crop(ndvi050316, extent(ndvi050316, 80, 159, 1601, 1800))
ndvi052616.2.9 <- crop(ndvi052616, extent(ndvi052616, 80, 159, 1601, 1800))
ndvi062316.2.9 <- crop(ndvi062316, extent(ndvi062316, 80, 159, 1601, 1800))
ndvi062916.2.9 <- crop(ndvi062916, extent(ndvi062916, 80, 159, 1601, 1800))
...
ndvi050316.2.9.p <- ndvi050316.2.9.p + labs(title = "Rush Ranch Block 1, Section 9.2\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.2.9.p
...
ndvi052616.2.9.p <- ndvi052616.2.9.p + labs(title = "Rush Ranch Block 1, Section 9.2\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.2.9.p
...
ndvi062316.2.9.p <- ndvi062316.2.9.p + labs(title = "Rush Ranch Block 1, Section 9.2\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.2.9.p
...
ndvi062916.2.9.p <- ndvi062916.2.9.p + labs(title = "Rush Ranch Block 1, Section 9.2\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.2.9.p
...
ndvi072716.2.9.p <- ndvi072716.2.9.p + labs(title = "Rush Ranch Block 1, Section 9.2\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.2.9.p
...
ndvi081716.2.9.p <- ndvi081716.2.9.p + labs(title = "Rush Ranch Block 1, Section 9.2\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.2.9.p
...
ndvi082416.2.9.p <- ndvi082416.2.9.p + labs(title = "Rush Ranch Block 1, Section 9.2\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.2.9.p
ggsave(file = "082416.9.2.png")

set.seed(131)
ndvi050316.2.9.us <- na.omit(ndvi050316.2.9.us); ndvi050316.2.9.rs <- sample_n(ndvi050316.2.9.us, 13900); ndvi050316.2.9.rs$Date <- "a"
ndvi052616.2.9.us <- na.omit(ndvi052616.2.9.us); ndvi052616.2.9.rs <- sample_n(ndvi052616.2.9.us, 13900); ndvi052616.2.9.rs$Date <- "b"
ndvi062316.2.9.us <- na.omit(ndvi062316.2.9.us); ndvi062316.2.9.rs <- sample_n(ndvi062316.2.9.us, 13900); ndvi062316.2.9.rs$Date <- "c"
ndvi062916.2.9.us <- na.omit(ndvi062916.2.9.us); ndvi062916.2.9.rs <- sample_n(ndvi062916.2.9.us, 13900); ndvi062916.2.9.rs$Date <- "d"
ndvi072716.2.9.us <- na.omit(ndvi072716.2.9.us); ndvi072716.2.9.rs <- sample_n(ndvi072716.2.9.us, 13900); ndvi072716.2.9.rs$Date <- "e"
ndvi081716.2.9.us <- na.omit(ndvi081716.2.9.us); ndvi081716.2.9.rs <- sample_n(ndvi081716.2.9.us, 13900); ndvi081716.2.9.rs$Date <- "f"
ndvi082416.2.9.us <- na.omit(ndvi082416.2.9.us); ndvi082416.2.9.rs <- sample_n(ndvi082416.2.9.us, 13900); ndvi082416.2.9.rs$Date <- "g"
...
rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 9.2\n2016 NDVI Values")
rrblrsp
...
ndvi050316.3.9 <- crop(ndvi050316, extent(ndvi050316, 160, 239, 1601, 1800))
ndvi052616.3.9 <- crop(ndvi052616, extent(ndvi052616, 160, 239, 1601, 1800))
ndvi062316.3.9 <- crop(ndvi062316, extent(ndvi062316, 160, 239, 1601, 1800))
ndvi062916.3.9 <- crop(ndvi062916, extent(ndvi062916, 160, 239, 1601, 1800))
...
ndvi050316.3.9.p <- ndvi050316.3.9.p + labs(title = "Rush Ranch Block 1, Section 9.3\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.3.9.p
...
ndvi052616.3.9.p <- ndvi052616.3.9.p + labs(title = "Rush Ranch Block 1, Section 9.3\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.3.9.p
...
ndvi062316.3.9.p <- ndvi062316.3.9.p + labs(title = "Rush Ranch Block 1, Section 9.3\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.3.9.p
...
ndvi062916.3.9.p <- ndvi062916.3.9.p + labs(title = "Rush Ranch Block 1, Section 9.3\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.3.9.p
...
ndvi072716.3.9.p <- ndvi072716.3.9.p + labs(title = "Rush Ranch Block 1, Section 9.3\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.3.9.p
...
ndvi081716.3.9.p <- ndvi081716.3.9.p + labs(title = "Rush Ranch Block 1, Section 9.3\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.3.9.p
...
ndvi082416.3.9.p <- ndvi082416.3.9.p + labs(title = "Rush Ranch Block 1, Section 9.3\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.3.9.p
...
rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 9.3\n2016 NDVI Values")
rrblrsp
...
##############################################################
ndvi050316.4.9 <- crop(ndvi050316, extent(ndvi050316, 240, 319, 1601, 1800))
ndvi052616.4.9 <- crop(ndvi052616, extent(ndvi052616, 240, 319, 1601, 1800))
ndvi062316.4.9 <- crop(ndvi062316, extent(ndvi062316, 240, 319, 1601, 1800))
ndvi062916.4.9 <- crop(ndvi062916, extent(ndvi062916, 240, 319, 1601, 1800))
...
ndvi050316.4.9.p <- ndvi050316.4.9.p + labs(title = "Rush Ranch Block 1, Section 9.4\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.4.9.p
...
ndvi052616.4.9.p <- ndvi052616.4.9.p + labs(title = "Rush Ranch Block 1, Section 9.4\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.4.9.p
...
ndvi062316.4.9.p <- ndvi062316.4.9.p + labs(title = "Rush Ranch Block 1, Section 9.4\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.4.9.p
...
ndvi062916.4.9.p <- ndvi062916.4.9.p + labs(title = "Rush Ranch Block 1, Section 9.4\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.4.9.p
...
ndvi072716.4.9.p <- ndvi072716.4.9.p + labs(title = "Rush Ranch Block 1, Section 9.4\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.4.9.p
...
ndvi081716.4.9.p <- ndvi081716.4.9.p + labs(title = "Rush Ranch Block 1, Section 9.4\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.4.9.p
...
ndvi082416.4.9.p <- ndvi082416.4.9.p + labs(title = "Rush Ranch Block 1, Section 9.4\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.4.9.p
...
rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 9.4\n2016 NDVI Values")
rrblrsp
...
ndvi050316.5.9 <- crop(ndvi050316, extent(ndvi050316, 320, 399, 1601, 1800))
ndvi052616.5.9 <- crop(ndvi052616, extent(ndvi052616, 320, 399, 1601, 1800))
ndvi062316.5.9 <- crop(ndvi062316, extent(ndvi062316, 320, 399, 1601, 1800))
ndvi062916.5.9 <- crop(ndvi062916, extent(ndvi062916, 320, 399, 1601, 1800))
...
ndvi050316.5.9.p <- ndvi050316.5.9.p + labs(title = "Rush Ranch Block 1, Section 9.5\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.5.9.p
...
ndvi052616.5.9.p <- ndvi052616.5.9.p + labs(title = "Rush Ranch Block 1, Section 9.5\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.5.9.p
...
ndvi062316.5.9.p <- ndvi062316.5.9.p + labs(title = "Rush Ranch Block 1, Section 9.5\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.5.9.p
...
ndvi062916.5.9.p <- ndvi062916.5.9.p + labs(title = "Rush Ranch Block 1, Section 9.5\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.5.9.p
...
ndvi072716.5.9.p <- ndvi072716.5.9.p + labs(title = "Rush Ranch Block 1, Section 9.5\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.5.9.p
...
ndvi081716.5.9.p <- ndvi081716.5.9.p + labs(title = "Rush Ranch Block 1, Section 9.5\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.5.9.p
...
ndvi082416.5.9.p <- ndvi082416.5.9.p + labs(title = "Rush Ranch Block 1, Section 9.5\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.5.9.p
...
rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 9.5\n2016 NDVI Values")
rrblrsp
...
ndvi050316.6.9 <- crop(ndvi050316, extent(ndvi050316, 400, 479, 1601, 1800))
ndvi052616.6.9 <- crop(ndvi052616, extent(ndvi052616, 400, 479, 1601, 1800))
ndvi062316.6.9 <- crop(ndvi062316, extent(ndvi062316, 400, 479, 1601, 1800))
ndvi062916.6.9 <- crop(ndvi062916, extent(ndvi062916, 400, 479, 1601, 1800))
...
ndvi050316.6.9.p <- ndvi050316.6.9.p + labs(title = "Rush Ranch Block 1, Section 9.6\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.6.9.p
...
ndvi052616.6.9.p <- ndvi052616.6.9.p + labs(title = "Rush Ranch Block 1, Section 9.6\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.6.9.p
...
ndvi062316.6.9.p <- ndvi062316.6.9.p + labs(title = "Rush Ranch Block 1, Section 9.6\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.6.9.p
...
ndvi062916.6.9.p <- ndvi062916.6.9.p + labs(title = "Rush Ranch Block 1, Section 9.6\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.6.9.p
...
ndvi072716.6.9.p <- ndvi072716.6.9.p + labs(title = "Rush Ranch Block 1, Section 9.6\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.6.9.p
...
ndvi081716.6.9.p <- ndvi081716.6.9.p + labs(title = "Rush Ranch Block 1, Section 9.6\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.6.9.p
...
ndvi082416.6.9.p <- ndvi082416.6.9.p + labs(title = "Rush Ranch Block 1, Section 9.6\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.6.9.p
...
rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 9.6\n2016 NDVI Values")
rrblrsp
...
ndvi050316.7.9 <- crop(ndvi050316, extent(ndvi050316, 480, 559, 1601, 1800))
ndvi052616.7.9 <- crop(ndvi052616, extent(ndvi052616, 480, 559, 1601, 1800))
ndvi062316.7.9 <- crop(ndvi062316, extent(ndvi062316, 480, 559, 1601, 1800))
ndvi062916.7.9 <- crop(ndvi062916, extent(ndvi062916, 480, 559, 1601, 1800))
...
ndvi050316.7.9.p <- ndvi050316.7.9.p + labs(title = "Rush Ranch Block 1, Section 9.7\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.7.9.p
...
ndvi052616.7.9.p <- ndvi052616.7.9.p + labs(title = "Rush Ranch Block 1, Section 9.7\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.7.9.p
...
ndvi062316.7.9.p <- ndvi062316.7.9.p + labs(title = "Rush Ranch Block 1, Section 9.7\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.7.9.p
...
ndvi062916.7.9.p <- ndvi062916.7.9.p + labs(title = "Rush Ranch Block 1, Section 9.7\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.7.9.p
...
ndvi072716.7.9.p <- ndvi072716.7.9.p + labs(title = "Rush Ranch Block 1, Section 9.7\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.7.9.p
...
ndvi081716.7.9.p <- ndvi081716.7.9.p + labs(title = "Rush Ranch Block 1, Section 9.7\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.7.9.p
...
ndvi082416.7.9.p <- ndvi082416.7.9.p + labs(title = "Rush Ranch Block 1, Section 9.7\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.7.9.p
...
rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 9.7\n2016 NDVI Values")
rrblrsp
...
ndvi050316.8.9 <- crop(ndvi050316, extent(ndvi050316, 560, 639, 1601, 1800))
ndvi052616.8.9 <- crop(ndvi052616, extent(ndvi052616, 560, 639, 1601, 1800))
ndvi062316.8.9 <- crop(ndvi062316, extent(ndvi062316, 560, 639, 1601, 1800))
ndvi062916.8.9 <- crop(ndvi062916, extent(ndvi062916, 560, 639, 1601, 1800))
...
set.seed(131)
ndvi050316.8.9.us <- na.omit(ndvi050316.8.9.us); ndvi050316.8.9.rs <- sample_n(ndvi050316.8.9.us, 15000); ndvi050316.8.9.rs$Date <- "a"
ndvi052616.8.9.us <- na.omit(ndvi052616.8.9.us); ndvi052616.8.9.rs <- sample_n(ndvi052616.8.9.us, 15000); ndvi052616.8.9.rs$Date <- "b"
ndvi062316.8.9.us <- na.omit(ndvi062316.8.9.us); ndvi062316.8.9.rs <- sample_n(ndvi062316.8.9.us, 15000); ndvi062316.8.9.rs$Date <- "c"
ndvi062916.8.9.us <- na.omit(ndvi062916.8.9.us); ndvi062916.8.9.rs <- sample_n(ndvi062916.8.9.us, 15000); ndvi062916.8.9.rs$Date <- "d"
ndvi072716.8.9.us <- na.omit(ndvi072716.8.9.us); ndvi072716.8.9.rs <- sample_n(ndvi072716.8.9.us, 15000); ndvi072716.8.9.rs$Date <- "e"
ndvi081716.8.9.us <- na.omit(ndvi081716.8.9.us); ndvi081716.8.9.rs <- sample_n(ndvi081716.8.9.us, 15000); ndvi081716.8.9.rs$Date <- "f"
ndvi082416.8.9.us <- na.omit(ndvi082416.8.9.us); ndvi082416.8.9.rs <- sample_n(ndvi082416.8.9.us, 15000); ndvi082416.8.9.rs$Date <- "g"
...
ndvi050316.9.9 <- crop(ndvi050316, extent(ndvi050316, 640, 719, 1601, 1800))
ndvi052616.9.9 <- crop(ndvi052616, extent(ndvi052616, 640, 719, 1601, 1800))
ndvi062316.9.9 <- crop(ndvi062316, extent(ndvi062316, 640, 719, 1601, 1800))
ndvi062916.9.9 <- crop(ndvi062916, extent(ndvi062916, 640, 719, 1601, 1800))
...
set.seed(131)
ndvi050316.9.9.us <- na.omit(ndvi050316.9.9.us); ndvi050316.9.9.rs <- sample_n(ndvi050316.9.9.us, 5400); ndvi050316.9.9.rs$Date <- "a"
ndvi052616.9.9.us <- na.omit(ndvi052616.9.9.us); ndvi052616.9.9.rs <- sample_n(ndvi052616.9.9.us, 5400); ndvi052616.9.9.rs$Date <- "b"
ndvi062316.9.9.us <- na.omit(ndvi062316.9.9.us); ndvi062316.9.9.rs <- sample_n(ndvi062316.9.9.us, 5400); ndvi062316.9.9.rs$Date <- "c"
ndvi062916.9.9.us <- na.omit(ndvi062916.9.9.us); ndvi062916.9.9.rs <- sample_n(ndvi062916.9.9.us, 5400); ndvi062916.9.9.rs$Date <- "d"
ndvi072716.9.9.us <- na.omit(ndvi072716.9.9.us); ndvi072716.9.9.rs <- sample_n(ndvi072716.9.9.us, 5400); ndvi072716.9.9.rs$Date <- "e"
ndvi081716.9.9.us <- na.omit(ndvi081716.9.9.us); ndvi081716.9.9.rs <- sample_n(ndvi081716.9.9.us, 5400); ndvi081716.9.9.rs$Date <- "f"
ndvi082416.9.9.us <- na.omit(ndvi082416.9.9.us); ndvi082416.9.9.rs <- sample_n(ndvi082416.9.9.us, 5400); ndvi082416.9.9.rs$Date <- "g"
...
ndvi050316.10.9 <- crop(ndvi050316, extent(ndvi050316, 720, 798, 1601, 1800))
ndvi052616.10.9 <- crop(ndvi052616, extent(ndvi052616, 720, 798, 1601, 1800))
ndvi062316.10.9 <- crop(ndvi062316, extent(ndvi062316, 720, 795, 1601, 1800))
ndvi062916.10.9 <- crop(ndvi062916, extent(ndvi062916, 720, 771, 1601, 1800))
...
ndvi050316.10.9.p <- ndvi050316.10.9.p + labs(title = "Rush Ranch Block 1, Section 9.10\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.10.9.p
...
ndvi052616.10.9.p <- ndvi052616.10.9.p + labs(title = "Rush Ranch Block 1, Section 9.10\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.10.9.p
...
ndvi062316.10.9.p <- ndvi062316.10.9.p + labs(title = "Rush Ranch Block 1, Section 9.10\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.10.9.p
...
ndvi062916.10.9.p <- ndvi062916.10.9.p + labs(title = "Rush Ranch Block 1, Section 9.10\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.10.9.p
...
ndvi072716.10.9.p <- ndvi072716.10.9.p + labs(title = "Rush Ranch Block 1, Section 9.10\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.10.9.p
...
ndvi081716.10.9.p <- ndvi081716.10.9.p + labs(title = "Rush Ranch Block 1, Section 9.10\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.10.9.p
...
ndvi082416.10.9.p <- ndvi082416.10.9.p + labs(title = "Rush Ranch Block 1, Section 9.10\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.10.9.p
...
# rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
# rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
# rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 9.10\n2016 NDVI Values")
# rrblrsp
