...
##############################################################
ndvi050316.4.3 <- crop(ndvi050316, extent(ndvi050316, 240, 319, 601, 800))
ndvi052616.4.3 <- crop(ndvi052616, extent(ndvi052616, 240, 319, 601, 800))
ndvi062316.4.3 <- crop(ndvi062316, extent(ndvi062316, 240, 319, 601, 800))
ndvi062916.4.3 <- crop(ndvi062916, extent(ndvi062916, 240, 319, 601, 800))
ndvi072716.4.3 <- crop(ndvi072716, extent(ndvi072716, 240, 319, 601, 800))
ndvi081716.4.3 <- crop(ndvi081716, extent(ndvi081716, 240, 319, 601, 800))
ndvi082416.4.3 <- crop(ndvi082416, extent(ndvi082416, 240, 319, 601, 800))
...
ndvi050316.5.3 <- crop(ndvi050316, extent(ndvi050316, 320, 399, 601, 800))
ndvi052616.5.3 <- crop(ndvi052616, extent(ndvi052616, 320, 399, 601, 800))
ndvi062316.5.3 <- crop(ndvi062316, extent(ndvi062316, 320, 399, 601, 800))
ndvi062916.5.3 <- crop(ndvi062916, extent(ndvi062916, 320, 399, 601, 800))
ndvi072716.5.3 <- crop(ndvi072716, extent(ndvi072716, 320, 399, 601, 800))
ndvi081716.5.3 <- crop(ndvi081716, extent(ndvi081716, 320, 399, 601, 800))
ndvi082416.5.3 <- crop(ndvi082416, extent(ndvi082416, 320, 399, 601, 800))
