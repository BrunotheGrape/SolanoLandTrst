...
ndvi050316.1.3 <- crop(ndvi050316, extent(ndvi050316, 1, 79, 401, 600))
ndvi052616.1.3 <- crop(ndvi052616, extent(ndvi052616, 1, 79, 401, 600))
ndvi062316.1.3 <- crop(ndvi062316, extent(ndvi062316, 1, 79, 401, 600))
ndvi062916.1.3 <- crop(ndvi062916, extent(ndvi062916, 1, 79, 401, 600))
ndvi072716.1.3 <- crop(ndvi072716, extent(ndvi072716, 1, 79, 401, 600))
ndvi081716.1.3 <- crop(ndvi081716, extent(ndvi081716, 1, 79, 401, 600))
ndvi082416.1.3 <- crop(ndvi082416, extent(ndvi082416, 1, 79, 401, 600))
...
# 
# image(ndvi050316)
image(ndvi082416.1.3)

ndvi050316.1.3.st <- stack(ndvi050316.1.3)
ndvi052616.1.3.st <- stack(ndvi052616.1.3)
ndvi062316.1.3.st <- stack(ndvi062316.1.3)
ndvi062916.1.3.st <- stack(ndvi062916.1.3)
ndvi072716.1.3.st <- stack(ndvi072716.1.3)
ndvi081716.1.3.st <- stack(ndvi081716.1.3)
ndvi082416.1.3.st <- stack(ndvi082416.1.3)

ndvi050316.1.3.df <- as.data.frame(ndvi050316.1.3.st);colnames(ndvi050316.1.3.df) <- "NDVI"; ndvi050316.1.3.df$observation <- 1:nrow(ndvi050316.1.3.df)

ndvi052616.1.3.df <- as.data.frame(ndvi052616.1.3.st);colnames(ndvi052616.1.3.df) <- "NDVI"; ndvi052616.1.3.df$observation <- 1:nrow(ndvi052616.1.3.df)

ndvi062316.1.3.df <- as.data.frame(ndvi062316.1.3.st); colnames(ndvi062316.1.3.df) <- "NDVI"; ndvi062316.1.3.df$observation <- 1:nrow(ndvi062316.1.3.df)

ndvi062916.1.3.df <- as.data.frame(ndvi062916.1.3.st); colnames(ndvi062916.1.3.df) <- "NDVI"; ndvi062916.1.3.df$observation <- 1:nrow(ndvi062916.1.3.df)

ndvi072716.1.3.df <- as.data.frame(ndvi072716.1.3.st); colnames(ndvi072716.1.3.df) <- "NDVI"; ndvi072716.1.3.df$observation <- 1:nrow(ndvi072716.1.3.df)

ndvi081716.1.3.df <- as.data.frame(ndvi081716.1.3.st); colnames(ndvi081716.1.3.df) <- "NDVI"; ndvi081716.1.3.df$observation <- 1:nrow(ndvi081716.1.3.df)

ndvi082416.1.3.df <- as.data.frame(ndvi082416.1.3.st);colnames(ndvi082416.1.3.df) <- "NDVI"; ndvi082416.1.3.df$observation <- 1:nrow(ndvi082416.1.3.df)


ndvi050316.1.3.st.av <- cellStats(ndvi050316.1.3.st, mean)
ndvi050316.1.3.st.md <- cellStats(ndvi050316.1.3.st, median)
ndvi050316.1.3.st.mx <- cellStats(ndvi050316.1.3.st, max)
ndvi050316.1.3.st.mn <- cellStats(ndvi050316.1.3.st, min)
ndvi050316.1.3.st.sd <- sd(ndvi050316.1.3.df$NDVI, na.rm = TRUE)

ndvi052616.1.3.st.av <- cellStats(ndvi052616.1.3.st, mean)
ndvi052616.1.3.st.md <- cellStats(ndvi052616.1.3.st, median)
ndvi052616.1.3.st.mx <- cellStats(ndvi052616.1.3.st, max)
ndvi052616.1.3.st.mn <- cellStats(ndvi052616.1.3.st, min)
ndvi052616.1.3.st.sd <- sd(ndvi052616.1.3.df$NDVI, na.rm = TRUE)

ndvi062316.1.3.st.av <- cellStats(ndvi062316.1.3.st, mean)
ndvi062316.1.3.st.md <- cellStats(ndvi062316.1.3.st, median)
ndvi062316.1.3.st.mx <- cellStats(ndvi062316.1.3.st, max)
ndvi062316.1.3.st.mn <- cellStats(ndvi062316.1.3.st, min)
ndvi062316.1.3.st.sd <- sd(ndvi062316.1.3.df$NDVI, na.rm = TRUE)

ndvi062916.1.3.st.av <- cellStats(ndvi062916.1.3.st, mean)
ndvi062916.1.3.st.md <- cellStats(ndvi062916.1.3.st, median)
ndvi062916.1.3.st.mx <- cellStats(ndvi062916.1.3.st, max)
ndvi062916.1.3.st.mn <- cellStats(ndvi062916.1.3.st, min)
ndvi062916.1.3.st.sd <- sd(ndvi062916.1.3.df$NDVI, na.rm = TRUE)

ndvi072716.1.3.st.av <- cellStats(ndvi072716.1.3.st, mean)
ndvi072716.1.3.st.md <- cellStats(ndvi072716.1.3.st, median)
ndvi072716.1.3.st.mx <- cellStats(ndvi072716.1.3.st, max)
ndvi072716.1.3.st.mn <- cellStats(ndvi072716.1.3.st, min)
ndvi072716.1.3.st.sd <- sd(ndvi072716.1.3.df$NDVI, na.rm = TRUE)

ndvi081716.1.3.st.av <- cellStats(ndvi081716.1.3.st, mean)
ndvi081716.1.3.st.md <- cellStats(ndvi081716.1.3.st, median)
ndvi081716.1.3.st.mx <- cellStats(ndvi081716.1.3.st, max)
ndvi081716.1.3.st.mn <- cellStats(ndvi081716.1.3.st, min)
ndvi081716.1.3.st.sd <- sd(ndvi081716.1.3.df$NDVI, na.rm = TRUE)

ndvi082416.1.3.st.av <- cellStats(ndvi082416.1.3.st, mean)
ndvi082416.1.3.st.md <- cellStats(ndvi082416.1.3.st, median)
ndvi082416.1.3.st.mx <- cellStats(ndvi082416.1.3.st, max)
ndvi082416.1.3.st.mn <- cellStats(ndvi082416.1.3.st, min)
ndvi082416.1.3.st.sd <- sd(ndvi082416.1.3.df$NDVI, na.rm = TRUE)

ndviav <- data.frame(Average = c(ndvi050316.1.3.st.av, ndvi052616.1.3.st.av, ndvi062316.1.3.st.av, ndvi062916.1.3.st.av,
                                 ndvi072716.1.3.st.av, ndvi081716.1.3.st.av, ndvi082416.1.3.st.av))

ndvimd <- data.frame(Median = c(ndvi050316.1.3.st.md, ndvi052616.1.3.st.md, ndvi062316.1.3.st.md, ndvi062916.1.3.st.md,
                                ndvi072716.1.3.st.md, ndvi081716.1.3.st.md, ndvi082416.1.3.st.md))

ndvisd <- data.frame(StandardDeviation = c(ndvi050316.1.3.st.sd, ndvi052616.1.3.st.sd, ndvi062316.1.3.st.sd, ndvi062916.1.3.st.sd,
                                           ndvi072716.1.3.st.sd, ndvi081716.1.3.st.sd, ndvi082416.1.3.st.sd))

ndvimx <- data.frame(Maximum = c(ndvi050316.1.3.st.mx, ndvi052616.1.3.st.mx, ndvi062316.1.3.st.mx, ndvi062916.1.3.st.mx,
                                 ndvi072716.1.3.st.mx, ndvi081716.1.3.st.mx, ndvi082416.1.3.st.mx))

ndvimn <- data.frame(Minimum = c(ndvi050316.1.3.st.mn, ndvi052616.1.3.st.mn, ndvi062316.1.3.st.mn, ndvi062916.1.3.st.mn,
                                 ndvi072716.1.3.st.mn, ndvi081716.1.3.st.mn, ndvi082416.1.3.st.mn))
...
write.csv(rrbldf, "RushRanchBlk1_2016.3.1.csv")

options(device = "RStudioGD")
ndvi050316.1.3.us <- unstack(ndvi050316.1.3.df); colnames(ndvi050316.1.3.us) <- "NDVI"
ndvi052616.1.3.us <- unstack(ndvi052616.1.3.df); colnames(ndvi052616.1.3.us) <- "NDVI"
ndvi062316.1.3.us <- unstack(ndvi062316.1.3.df); colnames(ndvi062316.1.3.us) <- "NDVI"
ndvi062916.1.3.us <- unstack(ndvi062916.1.3.df); colnames(ndvi062916.1.3.us) <- "NDVI"
ndvi072716.1.3.us <- unstack(ndvi072716.1.3.df); colnames(ndvi072716.1.3.us) <- "NDVI"
ndvi081716.1.3.us <- unstack(ndvi081716.1.3.df); colnames(ndvi081716.1.3.us) <- "NDVI"
ndvi082416.1.3.us <- unstack(ndvi082416.1.3.df); colnames(ndvi082416.1.3.us) <- "NDVI"

ndvi050316.1.3.p <- ggplot(ndvi050316.1.3.us, aes(ndvi050316.1.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi050316.1.3.p <- ndvi050316.1.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi050316.1.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi050316.1.3.p <- ndvi050316.1.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi050316.1.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi050316.1.3.p <- ndvi050316.1.3.p + labs(title = "Rush Ranch Block 1, Section 3.1\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.1.3.p
ggsave(file = "050316.3.1.png")

ndvi052616.1.3.p <- ggplot(ndvi052616.1.3.us, aes(ndvi052616.1.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi052616.1.3.p <- ndvi052616.1.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi052616.1.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi052616.1.3.p <- ndvi052616.1.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi052616.1.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi052616.1.3.p <- ndvi052616.1.3.p + labs(title = "Rush Ranch Block 1, Section 3.1\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.1.3.p
ggsave(file = "052616.3.1.png")

ndvi062316.1.3.p <- ggplot(ndvi062316.1.3.us, aes(ndvi062316.1.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi062316.1.3.p <- ndvi062316.1.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi062316.1.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi062316.1.3.p <- ndvi062316.1.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi062316.1.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi062316.1.3.p <- ndvi062316.1.3.p + labs(title = "Rush Ranch Block 1, Section 3.1\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.1.3.p
ggsave(file = "062316.3.1.png")

ndvi062916.1.3.p <- ggplot(ndvi062916.1.3.us, aes(ndvi062916.1.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi062916.1.3.p <- ndvi062916.1.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi062916.1.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi062916.1.3.p <- ndvi062916.1.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi062916.1.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi062916.1.3.p <- ndvi062916.1.3.p + labs(title = "Rush Ranch Block 1, Section 3.1\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.1.3.p
ggsave(file = "062916.3.1.png")

ndvi072716.1.3.p <- ggplot(ndvi072716.1.3.us, aes(ndvi072716.1.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi072716.1.3.p <- ndvi072716.1.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi072716.1.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi072716.1.3.p <- ndvi072716.1.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi072716.1.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi072716.1.3.p <- ndvi072716.1.3.p + labs(title = "Rush Ranch Block 1, Section 3.1\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.1.3.p
ggsave(file = "072716.3.1.png")

ndvi081716.1.3.p <- ggplot(ndvi081716.1.3.us, aes(ndvi081716.1.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi081716.1.3.p <- ndvi081716.1.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi081716.1.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi081716.1.3.p <- ndvi081716.1.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi081716.1.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi081716.1.3.p <- ndvi081716.1.3.p + labs(title = "Rush Ranch Block 1, Section 3.1\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.1.3.p
ggsave(file = "081716.3.1.png")

ndvi082416.1.3.p <- ggplot(ndvi082416.1.3.us, aes(ndvi082416.1.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi082416.1.3.p <- ndvi082416.1.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi082416.1.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi082416.1.3.p <- ndvi082416.1.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi082416.1.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi082416.1.3.p <- ndvi082416.1.3.p + labs(title = "Rush Ranch Block 1, Section 3.1\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.1.3.p
ggsave(file = "082416.3.1.png")

set.seed(131)
ndvi050316.1.3.us <- na.omit(ndvi050316.1.3.us); ndvi050316.1.3.rs <- sample_n(ndvi050316.1.3.us, 95); ndvi050316.1.3.rs$Date <- "a"
ndvi052616.1.3.us <- na.omit(ndvi052616.1.3.us); ndvi052616.1.3.rs <- sample_n(ndvi052616.1.3.us, 180); ndvi052616.1.3.rs$Date <- "b"
ndvi062316.1.3.us <- na.omit(ndvi062316.1.3.us); ndvi062316.1.3.rs <- sample_n(ndvi062316.1.3.us, 250); ndvi062316.1.3.rs$Date <- "c"
ndvi062916.1.3.us <- na.omit(ndvi062916.1.3.us); ndvi062916.1.3.rs <- sample_n(ndvi062916.1.3.us, 750); ndvi062916.1.3.rs$Date <- "d"
ndvi072716.1.3.us <- na.omit(ndvi072716.1.3.us); ndvi072716.1.3.rs <- sample_n(ndvi072716.1.3.us, 900); ndvi072716.1.3.rs$Date <- "e"
ndvi081716.1.3.us <- na.omit(ndvi081716.1.3.us); ndvi081716.1.3.rs <- sample_n(ndvi081716.1.3.us, 720); ndvi081716.1.3.rs$Date <- "f"
ndvi082416.1.3.us <- na.omit(ndvi082416.1.3.us); ndvi082416.1.3.rs <- sample_n(ndvi082416.1.3.us, 360); ndvi082416.1.3.rs$Date <- "g"

rrblrs <- rbind(ndvi082416.1.3.rs, ndvi081716.1.3.rs)
rrblrs <- rbind(rrblrs, ndvi072716.1.3.rs)
rrblrs <- rbind(rrblrs, ndvi062916.1.3.rs)
rrblrs <- rbind(rrblrs, ndvi062316.1.3.rs)
rrblrs <- rbind(rrblrs, ndvi052616.1.3.rs)
rrblrs <- rbind(rrblrs, ndvi050316.1.3.rs)
...
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.1\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016violin.3.1.png")
...
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.1\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016box.3.1.png")

#######################################################################

ndvi050316.2.3 <- crop(ndvi050316, extent(ndvi050316, 80, 159, 401, 600))
ndvi052616.2.3 <- crop(ndvi052616, extent(ndvi052616, 80, 159, 401, 600))
ndvi062316.2.3 <- crop(ndvi062316, extent(ndvi062316, 80, 159, 401, 600))
ndvi062916.2.3 <- crop(ndvi062916, extent(ndvi062916, 80, 159, 401, 600))
ndvi072716.2.3 <- crop(ndvi072716, extent(ndvi072716, 80, 159, 401, 600))
ndvi081716.2.3 <- crop(ndvi081716, extent(ndvi081716, 80, 159, 401, 600))
ndvi082416.2.3 <- crop(ndvi082416, extent(ndvi082416, 80, 159, 401, 600))
...
ndvi062316.2.3.st <- stack(ndvi062316.2.3)
ndvi062916.2.3.st <- stack(ndvi062916.2.3)
ndvi072716.2.3.st <- stack(ndvi072716.2.3)
ndvi081716.2.3.st <- stack(ndvi081716.2.3)
ndvi082416.2.3.st <- stack(ndvi082416.2.3)

ndvi050316.2.3.df <- as.data.frame(ndvi050316.2.3.st);colnames(ndvi050316.2.3.df) <- "NDVI"; ndvi050316.2.3.df$observation <- 1:nrow(ndvi050316.2.3.df)

ndvi052616.2.3.df <- as.data.frame(ndvi052616.2.3.st);colnames(ndvi052616.2.3.df) <- "NDVI"; ndvi052616.2.3.df$observation <- 1:nrow(ndvi052616.2.3.df)

ndvi062316.2.3.df <- as.data.frame(ndvi062316.2.3.st); colnames(ndvi062316.2.3.df) <- "NDVI"; ndvi062316.2.3.df$observation <- 1:nrow(ndvi062316.2.3.df)

ndvi062916.2.3.df <- as.data.frame(ndvi062916.2.3.st); colnames(ndvi062916.2.3.df) <- "NDVI"; ndvi062916.2.3.df$observation <- 1:nrow(ndvi062916.2.3.df)

ndvi072716.2.3.df <- as.data.frame(ndvi072716.2.3.st); colnames(ndvi072716.2.3.df) <- "NDVI"; ndvi072716.2.3.df$observation <- 1:nrow(ndvi072716.2.3.df)

ndvi081716.2.3.df <- as.data.frame(ndvi081716.2.3.st); colnames(ndvi081716.2.3.df) <- "NDVI"; ndvi081716.2.3.df$observation <- 1:nrow(ndvi081716.2.3.df)

ndvi082416.2.3.df <- as.data.frame(ndvi082416.2.3.st);colnames(ndvi082416.2.3.df) <- "NDVI"; ndvi082416.2.3.df$observation <- 1:nrow(ndvi082416.2.3.df)


ndvi050316.2.3.st.av <- cellStats(ndvi050316.2.3.st, mean)
ndvi050316.2.3.st.md <- cellStats(ndvi050316.2.3.st, median)
ndvi050316.2.3.st.mx <- cellStats(ndvi050316.2.3.st, max)
ndvi050316.2.3.st.mn <- cellStats(ndvi050316.2.3.st, min)
ndvi050316.2.3.st.sd <- sd(ndvi050316.2.3.df$NDVI, na.rm = TRUE)

ndvi052616.2.3.st.av <- cellStats(ndvi052616.2.3.st, mean)
ndvi052616.2.3.st.md <- cellStats(ndvi052616.2.3.st, median)
ndvi052616.2.3.st.mx <- cellStats(ndvi052616.2.3.st, max)
ndvi052616.2.3.st.mn <- cellStats(ndvi052616.2.3.st, min)
ndvi052616.2.3.st.sd <- sd(ndvi052616.2.3.df$NDVI, na.rm = TRUE)

ndvi062316.2.3.st.av <- cellStats(ndvi062316.2.3.st, mean)
ndvi062316.2.3.st.md <- cellStats(ndvi062316.2.3.st, median)
ndvi062316.2.3.st.mx <- cellStats(ndvi062316.2.3.st, max)
ndvi062316.2.3.st.mn <- cellStats(ndvi062316.2.3.st, min)
ndvi062316.2.3.st.sd <- sd(ndvi062316.2.3.df$NDVI, na.rm = TRUE)

ndvi062916.2.3.st.av <- cellStats(ndvi062916.2.3.st, mean)
ndvi062916.2.3.st.md <- cellStats(ndvi062916.2.3.st, median)
ndvi062916.2.3.st.mx <- cellStats(ndvi062916.2.3.st, max)
ndvi062916.2.3.st.mn <- cellStats(ndvi062916.2.3.st, min)
ndvi062916.2.3.st.sd <- sd(ndvi062916.2.3.df$NDVI, na.rm = TRUE)

ndvi072716.2.3.st.av <- cellStats(ndvi072716.2.3.st, mean)
ndvi072716.2.3.st.md <- cellStats(ndvi072716.2.3.st, median)
ndvi072716.2.3.st.mx <- cellStats(ndvi072716.2.3.st, max)
ndvi072716.2.3.st.mn <- cellStats(ndvi072716.2.3.st, min)
ndvi072716.2.3.st.sd <- sd(ndvi072716.2.3.df$NDVI, na.rm = TRUE)

ndvi081716.2.3.st.av <- cellStats(ndvi081716.2.3.st, mean)
ndvi081716.2.3.st.md <- cellStats(ndvi081716.2.3.st, median)
ndvi081716.2.3.st.mx <- cellStats(ndvi081716.2.3.st, max)
ndvi081716.2.3.st.mn <- cellStats(ndvi081716.2.3.st, min)
ndvi081716.2.3.st.sd <- sd(ndvi081716.2.3.df$NDVI, na.rm = TRUE)

ndvi082416.2.3.st.av <- cellStats(ndvi082416.2.3.st, mean)
ndvi082416.2.3.st.md <- cellStats(ndvi082416.2.3.st, median)
ndvi082416.2.3.st.mx <- cellStats(ndvi082416.2.3.st, max)
ndvi082416.2.3.st.mn <- cellStats(ndvi082416.2.3.st, min)
ndvi082416.2.3.st.sd <- sd(ndvi082416.2.3.df$NDVI, na.rm = TRUE)

ndviav <- data.frame(Average = c(ndvi050316.2.3.st.av, ndvi052616.2.3.st.av, ndvi062316.2.3.st.av, ndvi062916.2.3.st.av,
                                 ndvi072716.2.3.st.av, ndvi081716.2.3.st.av, ndvi082416.2.3.st.av))

ndvimd <- data.frame(Median = c(ndvi050316.2.3.st.md, ndvi052616.2.3.st.md, ndvi062316.2.3.st.md, ndvi062916.2.3.st.md,
                                ndvi072716.2.3.st.md, ndvi081716.2.3.st.md, ndvi082416.2.3.st.md))

ndvisd <- data.frame(StandardDeviation = c(ndvi050316.2.3.st.sd, ndvi052616.2.3.st.sd, ndvi062316.2.3.st.sd, ndvi062916.2.3.st.sd,
                                           ndvi072716.2.3.st.sd, ndvi081716.2.3.st.sd, ndvi082416.2.3.st.sd))

ndvimx <- data.frame(Maximum = c(ndvi050316.2.3.st.mx, ndvi052616.2.3.st.mx, ndvi062316.2.3.st.mx, ndvi062916.2.3.st.mx,
                                 ndvi072716.2.3.st.mx, ndvi081716.2.3.st.mx, ndvi082416.2.3.st.mx))

ndvimn <- data.frame(Minimum = c(ndvi050316.2.3.st.mn, ndvi052616.2.3.st.mn, ndvi062316.2.3.st.mn, ndvi062916.2.3.st.mn,
                                 ndvi072716.2.3.st.mn, ndvi081716.2.3.st.mn, ndvi082416.2.3.st.mn))
...
rrbldf <- cbind(rrbldf, ndvimx)
rrbldf <- cbind(rrbldf, ndvimn)
write.csv(rrbldf, "RushRanchBlk1_2016.3.2.csv")

options(device = "RStudioGD")
ndvi050316.2.3.us <- unstack(ndvi050316.2.3.df); colnames(ndvi050316.2.3.us) <- "NDVI"
ndvi052616.2.3.us <- unstack(ndvi052616.2.3.df); colnames(ndvi052616.2.3.us) <- "NDVI"
ndvi062316.2.3.us <- unstack(ndvi062316.2.3.df); colnames(ndvi062316.2.3.us) <- "NDVI"
ndvi062916.2.3.us <- unstack(ndvi062916.2.3.df); colnames(ndvi062916.2.3.us) <- "NDVI"
ndvi072716.2.3.us <- unstack(ndvi072716.2.3.df); colnames(ndvi072716.2.3.us) <- "NDVI"
ndvi081716.2.3.us <- unstack(ndvi081716.2.3.df); colnames(ndvi081716.2.3.us) <- "NDVI"
ndvi082416.2.3.us <- unstack(ndvi082416.2.3.df); colnames(ndvi082416.2.3.us) <- "NDVI"

ndvi050316.2.3.p <- ggplot(ndvi050316.2.3.us, aes(ndvi050316.2.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi050316.2.3.p <- ndvi050316.2.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi050316.2.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi050316.2.3.p <- ndvi050316.2.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi050316.2.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi050316.2.3.p <- ndvi050316.2.3.p + labs(title = "Rush Ranch Block 1, Section 3.2\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.2.3.p
ggsave(file = "050316.3.2.png")

ndvi052616.2.3.p <- ggplot(ndvi052616.2.3.us, aes(ndvi052616.2.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi052616.2.3.p <- ndvi052616.2.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi052616.2.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi052616.2.3.p <- ndvi052616.2.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi052616.2.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi052616.2.3.p <- ndvi052616.2.3.p + labs(title = "Rush Ranch Block 1, Section 3.2\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.2.3.p
ggsave(file = "052616.3.2.png")

ndvi062316.2.3.p <- ggplot(ndvi062316.2.3.us, aes(ndvi062316.2.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi062316.2.3.p <- ndvi062316.2.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi062316.2.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi062316.2.3.p <- ndvi062316.2.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi062316.2.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi062316.2.3.p <- ndvi062316.2.3.p + labs(title = "Rush Ranch Block 1, Section 3.2\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.2.3.p
ggsave(file = "062316.3.2.png")

ndvi062916.2.3.p <- ggplot(ndvi062916.2.3.us, aes(ndvi062916.2.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi062916.2.3.p <- ndvi062916.2.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi062916.2.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi062916.2.3.p <- ndvi062916.2.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi062916.2.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi062916.2.3.p <- ndvi062916.2.3.p + labs(title = "Rush Ranch Block 1, Section 3.2\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.2.3.p
ggsave(file = "062916.3.2.png")

ndvi072716.2.3.p <- ggplot(ndvi072716.2.3.us, aes(ndvi072716.2.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi072716.2.3.p <- ndvi072716.2.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi072716.2.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi072716.2.3.p <- ndvi072716.2.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi072716.2.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi072716.2.3.p <- ndvi072716.2.3.p + labs(title = "Rush Ranch Block 1, Section 3.2\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.2.3.p
ggsave(file = "072716.3.2.png")

ndvi081716.2.3.p <- ggplot(ndvi081716.2.3.us, aes(ndvi081716.2.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi081716.2.3.p <- ndvi081716.2.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi081716.2.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi081716.2.3.p <- ndvi081716.2.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi081716.2.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi081716.2.3.p <- ndvi081716.2.3.p + labs(title = "Rush Ranch Block 1, Section 3.2\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.2.3.p
ggsave(file = "081716.3.2.png")

ndvi082416.2.3.p <- ggplot(ndvi082416.2.3.us, aes(ndvi082416.2.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi082416.2.3.p <- ndvi082416.2.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi082416.2.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi082416.2.3.p <- ndvi082416.2.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi082416.2.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi082416.2.3.p <- ndvi082416.2.3.p + labs(title = "Rush Ranch Block 1, Section 3.2\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.2.3.p
...
rrblrs <- rbind(rrblrs, ndvi062916.2.3.rs)
rrblrs <- rbind(rrblrs, ndvi062316.2.3.rs)
rrblrs <- rbind(rrblrs, ndvi052616.2.3.rs)
rrblrs <- rbind(rrblrs, ndvi050316.2.3.rs)
...
rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.2\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016violin.3.2.png")
...
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.2\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016box.3.2.png")

####################################################################

ndvi050316.3.3 <- crop(ndvi050316, extent(ndvi050316, 160, 239, 401, 600))
ndvi052616.3.3 <- crop(ndvi052616, extent(ndvi052616, 160, 239, 401, 600))
ndvi062316.3.3 <- crop(ndvi062316, extent(ndvi062316, 160, 239, 401, 600))
ndvi062916.3.3 <- crop(ndvi062916, extent(ndvi062916, 160, 239, 401, 600))
ndvi072716.3.3 <- crop(ndvi072716, extent(ndvi072716, 160, 239, 401, 600))
ndvi081716.3.3 <- crop(ndvi081716, extent(ndvi081716, 160, 239, 401, 600))
ndvi082416.3.3 <- crop(ndvi082416, extent(ndvi082416, 160, 239, 401, 600))
...
# 
# image(ndvi050316)
image(ndvi082416.3.3)

ndvi050316.3.3.st <- stack(ndvi050316.3.3)
ndvi052616.3.3.st <- stack(ndvi052616.3.3)
ndvi062316.3.3.st <- stack(ndvi062316.3.3)
ndvi062916.3.3.st <- stack(ndvi062916.3.3)
ndvi072716.3.3.st <- stack(ndvi072716.3.3)
ndvi081716.3.3.st <- stack(ndvi081716.3.3)
ndvi082416.3.3.st <- stack(ndvi082416.3.3)

ndvi050316.3.3.df <- as.data.frame(ndvi050316.3.3.st);colnames(ndvi050316.3.3.df) <- "NDVI"; ndvi050316.3.3.df$observation <- 1:nrow(ndvi050316.3.3.df)

ndvi052616.3.3.df <- as.data.frame(ndvi052616.3.3.st);colnames(ndvi052616.3.3.df) <- "NDVI"; ndvi052616.3.3.df$observation <- 1:nrow(ndvi052616.3.3.df)

ndvi062316.3.3.df <- as.data.frame(ndvi062316.3.3.st); colnames(ndvi062316.3.3.df) <- "NDVI"; ndvi062316.3.3.df$observation <- 1:nrow(ndvi062316.3.3.df)

ndvi062916.3.3.df <- as.data.frame(ndvi062916.3.3.st); colnames(ndvi062916.3.3.df) <- "NDVI"; ndvi062916.3.3.df$observation <- 1:nrow(ndvi062916.3.3.df)

ndvi072716.3.3.df <- as.data.frame(ndvi072716.3.3.st); colnames(ndvi072716.3.3.df) <- "NDVI"; ndvi072716.3.3.df$observation <- 1:nrow(ndvi072716.3.3.df)

ndvi081716.3.3.df <- as.data.frame(ndvi081716.3.3.st); colnames(ndvi081716.3.3.df) <- "NDVI"; ndvi081716.3.3.df$observation <- 1:nrow(ndvi081716.3.3.df)

ndvi082416.3.3.df <- as.data.frame(ndvi082416.3.3.st);colnames(ndvi082416.3.3.df) <- "NDVI"; ndvi082416.3.3.df$observation <- 1:nrow(ndvi082416.3.3.df)


ndvi050316.3.3.st.av <- cellStats(ndvi050316.3.3.st, mean)
ndvi050316.3.3.st.md <- cellStats(ndvi050316.3.3.st, median)
ndvi050316.3.3.st.mx <- cellStats(ndvi050316.3.3.st, max)
ndvi050316.3.3.st.mn <- cellStats(ndvi050316.3.3.st, min)
ndvi050316.3.3.st.sd <- sd(ndvi050316.3.3.df$NDVI, na.rm = TRUE)

ndvi052616.3.3.st.av <- cellStats(ndvi052616.3.3.st, mean)
ndvi052616.3.3.st.md <- cellStats(ndvi052616.3.3.st, median)
ndvi052616.3.3.st.mx <- cellStats(ndvi052616.3.3.st, max)
ndvi052616.3.3.st.mn <- cellStats(ndvi052616.3.3.st, min)
ndvi052616.3.3.st.sd <- sd(ndvi052616.3.3.df$NDVI, na.rm = TRUE)

ndvi062316.3.3.st.av <- cellStats(ndvi062316.3.3.st, mean)
ndvi062316.3.3.st.md <- cellStats(ndvi062316.3.3.st, median)
ndvi062316.3.3.st.mx <- cellStats(ndvi062316.3.3.st, max)
ndvi062316.3.3.st.mn <- cellStats(ndvi062316.3.3.st, min)
ndvi062316.3.3.st.sd <- sd(ndvi062316.3.3.df$NDVI, na.rm = TRUE)

ndvi062916.3.3.st.av <- cellStats(ndvi062916.3.3.st, mean)
ndvi062916.3.3.st.md <- cellStats(ndvi062916.3.3.st, median)
ndvi062916.3.3.st.mx <- cellStats(ndvi062916.3.3.st, max)
ndvi062916.3.3.st.mn <- cellStats(ndvi062916.3.3.st, min)
ndvi062916.3.3.st.sd <- sd(ndvi062916.3.3.df$NDVI, na.rm = TRUE)

ndvi072716.3.3.st.av <- cellStats(ndvi072716.3.3.st, mean)
ndvi072716.3.3.st.md <- cellStats(ndvi072716.3.3.st, median)
ndvi072716.3.3.st.mx <- cellStats(ndvi072716.3.3.st, max)
ndvi072716.3.3.st.mn <- cellStats(ndvi072716.3.3.st, min)
ndvi072716.3.3.st.sd <- sd(ndvi072716.3.3.df$NDVI, na.rm = TRUE)

ndvi081716.3.3.st.av <- cellStats(ndvi081716.3.3.st, mean)
ndvi081716.3.3.st.md <- cellStats(ndvi081716.3.3.st, median)
ndvi081716.3.3.st.mx <- cellStats(ndvi081716.3.3.st, max)
ndvi081716.3.3.st.mn <- cellStats(ndvi081716.3.3.st, min)
ndvi081716.3.3.st.sd <- sd(ndvi081716.3.3.df$NDVI, na.rm = TRUE)

ndvi082416.3.3.st.av <- cellStats(ndvi082416.3.3.st, mean)
ndvi082416.3.3.st.md <- cellStats(ndvi082416.3.3.st, median)
ndvi082416.3.3.st.mx <- cellStats(ndvi082416.3.3.st, max)
ndvi082416.3.3.st.mn <- cellStats(ndvi082416.3.3.st, min)
ndvi082416.3.3.st.sd <- sd(ndvi082416.3.3.df$NDVI, na.rm = TRUE)

ndviav <- data.frame(Average = c(ndvi050316.3.3.st.av, ndvi052616.3.3.st.av, ndvi062316.3.3.st.av, ndvi062916.3.3.st.av,
                                 ndvi072716.3.3.st.av, ndvi081716.3.3.st.av, ndvi082416.3.3.st.av))

ndvimd <- data.frame(Median = c(ndvi050316.3.3.st.md, ndvi052616.3.3.st.md, ndvi062316.3.3.st.md, ndvi062916.3.3.st.md,
                                ndvi072716.3.3.st.md, ndvi081716.3.3.st.md, ndvi082416.3.3.st.md))

ndvisd <- data.frame(StandardDeviation = c(ndvi050316.3.3.st.sd, ndvi052616.3.3.st.sd, ndvi062316.3.3.st.sd, ndvi062916.3.3.st.sd,
                                           ndvi072716.3.3.st.sd, ndvi081716.3.3.st.sd, ndvi082416.3.3.st.sd))

ndvimx <- data.frame(Maximum = c(ndvi050316.3.3.st.mx, ndvi052616.3.3.st.mx, ndvi062316.3.3.st.mx, ndvi062916.3.3.st.mx,
                                 ndvi072716.3.3.st.mx, ndvi081716.3.3.st.mx, ndvi082416.3.3.st.mx))

ndvimn <- data.frame(Minimum = c(ndvi050316.3.3.st.mn, ndvi052616.3.3.st.mn, ndvi062316.3.3.st.mn, ndvi062916.3.3.st.mn,
                                 ndvi072716.3.3.st.mn, ndvi081716.3.3.st.mn, ndvi082416.3.3.st.mn))
...
rrbldf <- cbind(rrbldf, ndvimx)
rrbldf <- cbind(rrbldf, ndvimn)
write.csv(rrbldf, "RushRanchBlk1_2016.3.3.csv")

options(device = "RStudioGD")
ndvi050316.3.3.us <- unstack(ndvi050316.3.3.df); colnames(ndvi050316.3.3.us) <- "NDVI"
ndvi052616.3.3.us <- unstack(ndvi052616.3.3.df); colnames(ndvi052616.3.3.us) <- "NDVI"
ndvi062316.3.3.us <- unstack(ndvi062316.3.3.df); colnames(ndvi062316.3.3.us) <- "NDVI"
ndvi062916.3.3.us <- unstack(ndvi062916.3.3.df); colnames(ndvi062916.3.3.us) <- "NDVI"
ndvi072716.3.3.us <- unstack(ndvi072716.3.3.df); colnames(ndvi072716.3.3.us) <- "NDVI"
ndvi081716.3.3.us <- unstack(ndvi081716.3.3.df); colnames(ndvi081716.3.3.us) <- "NDVI"
ndvi082416.3.3.us <- unstack(ndvi082416.3.3.df); colnames(ndvi082416.3.3.us) <- "NDVI"

ndvi050316.3.3.p <- ggplot(ndvi050316.3.3.us, aes(ndvi050316.3.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi050316.3.3.p <- ndvi050316.3.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi050316.3.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi050316.3.3.p <- ndvi050316.3.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi050316.3.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi050316.3.3.p <- ndvi050316.3.3.p + labs(title = "Rush Ranch Block 1, Section 3.3\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.3.3.p
ggsave(file = "050316.3.3.png")

ndvi052616.3.3.p <- ggplot(ndvi052616.3.3.us, aes(ndvi052616.3.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi052616.3.3.p <- ndvi052616.3.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi052616.3.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi052616.3.3.p <- ndvi052616.3.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi052616.3.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi052616.3.3.p <- ndvi052616.3.3.p + labs(title = "Rush Ranch Block 1, Section 3.3\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.3.3.p
ggsave(file = "052616.3.3.png")

ndvi062316.3.3.p <- ggplot(ndvi062316.3.3.us, aes(ndvi062316.3.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi062316.3.3.p <- ndvi062316.3.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi062316.3.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi062316.3.3.p <- ndvi062316.3.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi062316.3.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi062316.3.3.p <- ndvi062316.3.3.p + labs(title = "Rush Ranch Block 1, Section 3.3\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.3.3.p
ggsave(file = "062316.3.3.png")

ndvi062916.3.3.p <- ggplot(ndvi062916.3.3.us, aes(ndvi062916.3.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi062916.3.3.p <- ndvi062916.3.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi062916.3.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi062916.3.3.p <- ndvi062916.3.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi062916.3.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi062916.3.3.p <- ndvi062916.3.3.p + labs(title = "Rush Ranch Block 1, Section 3.3\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.3.3.p
ggsave(file = "062916.3.3.png")

ndvi072716.3.3.p <- ggplot(ndvi072716.3.3.us, aes(ndvi072716.3.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi072716.3.3.p <- ndvi072716.3.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi072716.3.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi072716.3.3.p <- ndvi072716.3.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi072716.3.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi072716.3.3.p <- ndvi072716.3.3.p + labs(title = "Rush Ranch Block 1, Section 3.3\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.3.3.p
ggsave(file = "072716.3.3.png")

ndvi081716.3.3.p <- ggplot(ndvi081716.3.3.us, aes(ndvi081716.3.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi081716.3.3.p <- ndvi081716.3.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi081716.3.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi081716.3.3.p <- ndvi081716.3.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi081716.3.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi081716.3.3.p <- ndvi081716.3.3.p + labs(title = "Rush Ranch Block 1, Section 3.3\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.3.3.p
ggsave(file = "081716.3.3.png")

ndvi082416.3.3.p <- ggplot(ndvi082416.3.3.us, aes(ndvi082416.3.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi082416.3.3.p <- ndvi082416.3.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi082416.3.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi082416.3.3.p <- ndvi082416.3.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi082416.3.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi082416.3.3.p <- ndvi082416.3.3.p + labs(title = "Rush Ranch Block 1, Section 3.3\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.3.3.p
ggsave(file = "082416.3.3.png")

set.seed(131)
ndvi050316.3.3.us <- na.omit(ndvi050316.3.3.us); ndvi050316.3.3.rs <- sample_n(ndvi050316.3.3.us, 13000); ndvi050316.3.3.rs$Date <- "a"
ndvi052616.3.3.us <- na.omit(ndvi052616.3.3.us); ndvi052616.3.3.rs <- sample_n(ndvi052616.3.3.us, 13000); ndvi052616.3.3.rs$Date <- "b"
ndvi062316.3.3.us <- na.omit(ndvi062316.3.3.us); ndvi062316.3.3.rs <- sample_n(ndvi062316.3.3.us, 13000); ndvi062316.3.3.rs$Date <- "c"
ndvi062916.3.3.us <- na.omit(ndvi062916.3.3.us); ndvi062916.3.3.rs <- sample_n(ndvi062916.3.3.us, 13000); ndvi062916.3.3.rs$Date <- "d"
ndvi072716.3.3.us <- na.omit(ndvi072716.3.3.us); ndvi072716.3.3.rs <- sample_n(ndvi072716.3.3.us, 13000); ndvi072716.3.3.rs$Date <- "e"
ndvi081716.3.3.us <- na.omit(ndvi081716.3.3.us); ndvi081716.3.3.rs <- sample_n(ndvi081716.3.3.us, 13000); ndvi081716.3.3.rs$Date <- "f"
ndvi082416.3.3.us <- na.omit(ndvi082416.3.3.us); ndvi082416.3.3.rs <- sample_n(ndvi082416.3.3.us, 13000); ndvi082416.3.3.rs$Date <- "g"

rrblrs <- rbind(ndvi082416.3.3.rs, ndvi081716.3.3.rs)
rrblrs <- rbind(rrblrs, ndvi072716.3.3.rs)
rrblrs <- rbind(rrblrs, ndvi062916.3.3.rs)
rrblrs <- rbind(rrblrs, ndvi062316.3.3.rs)
rrblrs <- rbind(rrblrs, ndvi052616.3.3.rs)
rrblrs <- rbind(rrblrs, ndvi050316.3.3.rs)
...
rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.3\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016violin.3.3.png")
...
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.3\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016box.3.3.png")

##############################################################
ndvi050316.4.3 <- crop(ndvi050316, extent(ndvi050316, 240, 319, 401, 600))
ndvi052616.4.3 <- crop(ndvi052616, extent(ndvi052616, 240, 319, 401, 600))
ndvi062316.4.3 <- crop(ndvi062316, extent(ndvi062316, 240, 319, 401, 600))
ndvi062916.4.3 <- crop(ndvi062916, extent(ndvi062916, 240, 319, 401, 600))
ndvi072716.4.3 <- crop(ndvi072716, extent(ndvi072716, 240, 319, 401, 600))
ndvi081716.4.3 <- crop(ndvi081716, extent(ndvi081716, 240, 319, 401, 600))
ndvi082416.4.3 <- crop(ndvi082416, extent(ndvi082416, 240, 319, 401, 600))
...
# 
# image(ndvi050316)
image(ndvi082416.4.3)

ndvi050316.4.3.st <- stack(ndvi050316.4.3)
ndvi052616.4.3.st <- stack(ndvi052616.4.3)
ndvi062316.4.3.st <- stack(ndvi062316.4.3)
ndvi062916.4.3.st <- stack(ndvi062916.4.3)
ndvi072716.4.3.st <- stack(ndvi072716.4.3)
ndvi081716.4.3.st <- stack(ndvi081716.4.3)
ndvi082416.4.3.st <- stack(ndvi082416.4.3)

ndvi050316.4.3.df <- as.data.frame(ndvi050316.4.3.st);colnames(ndvi050316.4.3.df) <- "NDVI"; ndvi050316.4.3.df$observation <- 1:nrow(ndvi050316.4.3.df)

ndvi052616.4.3.df <- as.data.frame(ndvi052616.4.3.st);colnames(ndvi052616.4.3.df) <- "NDVI"; ndvi052616.4.3.df$observation <- 1:nrow(ndvi052616.4.3.df)

ndvi062316.4.3.df <- as.data.frame(ndvi062316.4.3.st); colnames(ndvi062316.4.3.df) <- "NDVI"; ndvi062316.4.3.df$observation <- 1:nrow(ndvi062316.4.3.df)

ndvi062916.4.3.df <- as.data.frame(ndvi062916.4.3.st); colnames(ndvi062916.4.3.df) <- "NDVI"; ndvi062916.4.3.df$observation <- 1:nrow(ndvi062916.4.3.df)

ndvi072716.4.3.df <- as.data.frame(ndvi072716.4.3.st); colnames(ndvi072716.4.3.df) <- "NDVI"; ndvi072716.4.3.df$observation <- 1:nrow(ndvi072716.4.3.df)

ndvi081716.4.3.df <- as.data.frame(ndvi081716.4.3.st); colnames(ndvi081716.4.3.df) <- "NDVI"; ndvi081716.4.3.df$observation <- 1:nrow(ndvi081716.4.3.df)

ndvi082416.4.3.df <- as.data.frame(ndvi082416.4.3.st);colnames(ndvi082416.4.3.df) <- "NDVI"; ndvi082416.4.3.df$observation <- 1:nrow(ndvi082416.4.3.df)


ndvi050316.4.3.st.av <- cellStats(ndvi050316.4.3.st, mean)
ndvi050316.4.3.st.md <- cellStats(ndvi050316.4.3.st, median)
ndvi050316.4.3.st.mx <- cellStats(ndvi050316.4.3.st, max)
ndvi050316.4.3.st.mn <- cellStats(ndvi050316.4.3.st, min)
ndvi050316.4.3.st.sd <- sd(ndvi050316.4.3.df$NDVI, na.rm = TRUE)

ndvi052616.4.3.st.av <- cellStats(ndvi052616.4.3.st, mean)
ndvi052616.4.3.st.md <- cellStats(ndvi052616.4.3.st, median)
ndvi052616.4.3.st.mx <- cellStats(ndvi052616.4.3.st, max)
ndvi052616.4.3.st.mn <- cellStats(ndvi052616.4.3.st, min)
ndvi052616.4.3.st.sd <- sd(ndvi052616.4.3.df$NDVI, na.rm = TRUE)

ndvi062316.4.3.st.av <- cellStats(ndvi062316.4.3.st, mean)
ndvi062316.4.3.st.md <- cellStats(ndvi062316.4.3.st, median)
ndvi062316.4.3.st.mx <- cellStats(ndvi062316.4.3.st, max)
ndvi062316.4.3.st.mn <- cellStats(ndvi062316.4.3.st, min)
ndvi062316.4.3.st.sd <- sd(ndvi062316.4.3.df$NDVI, na.rm = TRUE)

ndvi062916.4.3.st.av <- cellStats(ndvi062916.4.3.st, mean)
ndvi062916.4.3.st.md <- cellStats(ndvi062916.4.3.st, median)
ndvi062916.4.3.st.mx <- cellStats(ndvi062916.4.3.st, max)
ndvi062916.4.3.st.mn <- cellStats(ndvi062916.4.3.st, min)
ndvi062916.4.3.st.sd <- sd(ndvi062916.4.3.df$NDVI, na.rm = TRUE)

ndvi072716.4.3.st.av <- cellStats(ndvi072716.4.3.st, mean)
ndvi072716.4.3.st.md <- cellStats(ndvi072716.4.3.st, median)
ndvi072716.4.3.st.mx <- cellStats(ndvi072716.4.3.st, max)
ndvi072716.4.3.st.mn <- cellStats(ndvi072716.4.3.st, min)
ndvi072716.4.3.st.sd <- sd(ndvi072716.4.3.df$NDVI, na.rm = TRUE)

ndvi081716.4.3.st.av <- cellStats(ndvi081716.4.3.st, mean)
ndvi081716.4.3.st.md <- cellStats(ndvi081716.4.3.st, median)
ndvi081716.4.3.st.mx <- cellStats(ndvi081716.4.3.st, max)
ndvi081716.4.3.st.mn <- cellStats(ndvi081716.4.3.st, min)
ndvi081716.4.3.st.sd <- sd(ndvi081716.4.3.df$NDVI, na.rm = TRUE)

ndvi082416.4.3.st.av <- cellStats(ndvi082416.4.3.st, mean)
ndvi082416.4.3.st.md <- cellStats(ndvi082416.4.3.st, median)
ndvi082416.4.3.st.mx <- cellStats(ndvi082416.4.3.st, max)
ndvi082416.4.3.st.mn <- cellStats(ndvi082416.4.3.st, min)
ndvi082416.4.3.st.sd <- sd(ndvi082416.4.3.df$NDVI, na.rm = TRUE)

ndviav <- data.frame(Average = c(ndvi050316.4.3.st.av, ndvi052616.4.3.st.av, ndvi062316.4.3.st.av, ndvi062916.4.3.st.av,
                                 ndvi072716.4.3.st.av, ndvi081716.4.3.st.av, ndvi082416.4.3.st.av))

ndvimd <- data.frame(Median = c(ndvi050316.4.3.st.md, ndvi052616.4.3.st.md, ndvi062316.4.3.st.md, ndvi062916.4.3.st.md,
                                ndvi072716.4.3.st.md, ndvi081716.4.3.st.md, ndvi082416.4.3.st.md))

ndvisd <- data.frame(StandardDeviation = c(ndvi050316.4.3.st.sd, ndvi052616.4.3.st.sd, ndvi062316.4.3.st.sd, ndvi062916.4.3.st.sd,
                                           ndvi072716.4.3.st.sd, ndvi081716.4.3.st.sd, ndvi082416.4.3.st.sd))

ndvimx <- data.frame(Maximum = c(ndvi050316.4.3.st.mx, ndvi052616.4.3.st.mx, ndvi062316.4.3.st.mx, ndvi062916.4.3.st.mx,
                                 ndvi072716.4.3.st.mx, ndvi081716.4.3.st.mx, ndvi082416.4.3.st.mx))

ndvimn <- data.frame(Minimum = c(ndvi050316.4.3.st.mn, ndvi052616.4.3.st.mn, ndvi062316.4.3.st.mn, ndvi062916.4.3.st.mn,
                                 ndvi072716.4.3.st.mn, ndvi081716.4.3.st.mn, ndvi082416.4.3.st.mn))
...
rrbldf <- cbind(rrbldf, ndvimx)
rrbldf <- cbind(rrbldf, ndvimn)
write.csv(rrbldf, "RushRanchBlk1_2016.3.4.csv")

options(device = "RStudioGD")
ndvi050316.4.3.us <- unstack(ndvi050316.4.3.df); colnames(ndvi050316.4.3.us) <- "NDVI"
ndvi052616.4.3.us <- unstack(ndvi052616.4.3.df); colnames(ndvi052616.4.3.us) <- "NDVI"
ndvi062316.4.3.us <- unstack(ndvi062316.4.3.df); colnames(ndvi062316.4.3.us) <- "NDVI"
ndvi062916.4.3.us <- unstack(ndvi062916.4.3.df); colnames(ndvi062916.4.3.us) <- "NDVI"
ndvi072716.4.3.us <- unstack(ndvi072716.4.3.df); colnames(ndvi072716.4.3.us) <- "NDVI"
ndvi081716.4.3.us <- unstack(ndvi081716.4.3.df); colnames(ndvi081716.4.3.us) <- "NDVI"
ndvi082416.4.3.us <- unstack(ndvi082416.4.3.df); colnames(ndvi082416.4.3.us) <- "NDVI"

ndvi050316.4.3.p <- ggplot(ndvi050316.4.3.us, aes(ndvi050316.4.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi050316.4.3.p <- ndvi050316.4.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi050316.4.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi050316.4.3.p <- ndvi050316.4.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi050316.4.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi050316.4.3.p <- ndvi050316.4.3.p + labs(title = "Rush Ranch Block 1, Section 3.4\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.4.3.p
ggsave(file = "050316.3.4.png")

ndvi052616.4.3.p <- ggplot(ndvi052616.4.3.us, aes(ndvi052616.4.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi052616.4.3.p <- ndvi052616.4.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi052616.4.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi052616.4.3.p <- ndvi052616.4.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi052616.4.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi052616.4.3.p <- ndvi052616.4.3.p + labs(title = "Rush Ranch Block 1, Section 3.4\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.4.3.p
ggsave(file = "052616.3.4.png")

ndvi062316.4.3.p <- ggplot(ndvi062316.4.3.us, aes(ndvi062316.4.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi062316.4.3.p <- ndvi062316.4.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi062316.4.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi062316.4.3.p <- ndvi062316.4.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi062316.4.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi062316.4.3.p <- ndvi062316.4.3.p + labs(title = "Rush Ranch Block 1, Section 3.4\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.4.3.p
ggsave(file = "062316.3.4.png")

ndvi062916.4.3.p <- ggplot(ndvi062916.4.3.us, aes(ndvi062916.4.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi062916.4.3.p <- ndvi062916.4.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi062916.4.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi062916.4.3.p <- ndvi062916.4.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi062916.4.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi062916.4.3.p <- ndvi062916.4.3.p + labs(title = "Rush Ranch Block 1, Section 3.4\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.4.3.p
ggsave(file = "062916.3.4.png")

ndvi072716.4.3.p <- ggplot(ndvi072716.4.3.us, aes(ndvi072716.4.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi072716.4.3.p <- ndvi072716.4.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi072716.4.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi072716.4.3.p <- ndvi072716.4.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi072716.4.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi072716.4.3.p <- ndvi072716.4.3.p + labs(title = "Rush Ranch Block 1, Section 3.4\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.4.3.p
ggsave(file = "072716.3.4.png")

ndvi081716.4.3.p <- ggplot(ndvi081716.4.3.us, aes(ndvi081716.4.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi081716.4.3.p <- ndvi081716.4.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi081716.4.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi081716.4.3.p <- ndvi081716.4.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi081716.4.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi081716.4.3.p <- ndvi081716.4.3.p + labs(title = "Rush Ranch Block 1, Section 3.4\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.4.3.p
ggsave(file = "081716.3.4.png")

ndvi082416.4.3.p <- ggplot(ndvi082416.4.3.us, aes(ndvi082416.4.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi082416.4.3.p <- ndvi082416.4.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi082416.4.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi082416.4.3.p <- ndvi082416.4.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi082416.4.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi082416.4.3.p <- ndvi082416.4.3.p + labs(title = "Rush Ranch Block 1, Section 3.4\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.4.3.p
...
rrblrs <- rbind(rrblrs, ndvi062916.4.3.rs)
rrblrs <- rbind(rrblrs, ndvi062316.4.3.rs)
rrblrs <- rbind(rrblrs, ndvi052616.4.3.rs)
rrblrs <- rbind(rrblrs, ndvi050316.4.3.rs)
...
rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.4\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016violin.3.4.png")
...
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.4\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016box.3.4.png")


################################################################


ndvi050316.5.3 <- crop(ndvi050316, extent(ndvi050316, 320, 399, 401, 600))
ndvi052616.5.3 <- crop(ndvi052616, extent(ndvi052616, 320, 399, 401, 600))
ndvi062316.5.3 <- crop(ndvi062316, extent(ndvi062316, 320, 399, 401, 600))
ndvi062916.5.3 <- crop(ndvi062916, extent(ndvi062916, 320, 399, 401, 600))
ndvi072716.5.3 <- crop(ndvi072716, extent(ndvi072716, 320, 399, 401, 600))
ndvi081716.5.3 <- crop(ndvi081716, extent(ndvi081716, 320, 399, 401, 600))
ndvi082416.5.3 <- crop(ndvi082416, extent(ndvi082416, 320, 399, 401, 600))
...
# 
# image(ndvi050316)
image(ndvi082416.5.3)

ndvi050316.5.3.st <- stack(ndvi050316.5.3)
ndvi052616.5.3.st <- stack(ndvi052616.5.3)
ndvi062316.5.3.st <- stack(ndvi062316.5.3)
ndvi062916.5.3.st <- stack(ndvi062916.5.3)
ndvi072716.5.3.st <- stack(ndvi072716.5.3)
ndvi081716.5.3.st <- stack(ndvi081716.5.3)
ndvi082416.5.3.st <- stack(ndvi082416.5.3)

ndvi050316.5.3.df <- as.data.frame(ndvi050316.5.3.st);colnames(ndvi050316.5.3.df) <- "NDVI"; ndvi050316.5.3.df$observation <- 1:nrow(ndvi050316.5.3.df)

ndvi052616.5.3.df <- as.data.frame(ndvi052616.5.3.st);colnames(ndvi052616.5.3.df) <- "NDVI"; ndvi052616.5.3.df$observation <- 1:nrow(ndvi052616.5.3.df)

ndvi062316.5.3.df <- as.data.frame(ndvi062316.5.3.st); colnames(ndvi062316.5.3.df) <- "NDVI"; ndvi062316.5.3.df$observation <- 1:nrow(ndvi062316.5.3.df)

ndvi062916.5.3.df <- as.data.frame(ndvi062916.5.3.st); colnames(ndvi062916.5.3.df) <- "NDVI"; ndvi062916.5.3.df$observation <- 1:nrow(ndvi062916.5.3.df)

ndvi072716.5.3.df <- as.data.frame(ndvi072716.5.3.st); colnames(ndvi072716.5.3.df) <- "NDVI"; ndvi072716.5.3.df$observation <- 1:nrow(ndvi072716.5.3.df)

ndvi081716.5.3.df <- as.data.frame(ndvi081716.5.3.st); colnames(ndvi081716.5.3.df) <- "NDVI"; ndvi081716.5.3.df$observation <- 1:nrow(ndvi081716.5.3.df)

ndvi082416.5.3.df <- as.data.frame(ndvi082416.5.3.st);colnames(ndvi082416.5.3.df) <- "NDVI"; ndvi082416.5.3.df$observation <- 1:nrow(ndvi082416.5.3.df)


ndvi050316.5.3.st.av <- cellStats(ndvi050316.5.3.st, mean)
ndvi050316.5.3.st.md <- cellStats(ndvi050316.5.3.st, median)
ndvi050316.5.3.st.mx <- cellStats(ndvi050316.5.3.st, max)
ndvi050316.5.3.st.mn <- cellStats(ndvi050316.5.3.st, min)
ndvi050316.5.3.st.sd <- sd(ndvi050316.5.3.df$NDVI, na.rm = TRUE)

ndvi052616.5.3.st.av <- cellStats(ndvi052616.5.3.st, mean)
ndvi052616.5.3.st.md <- cellStats(ndvi052616.5.3.st, median)
ndvi052616.5.3.st.mx <- cellStats(ndvi052616.5.3.st, max)
ndvi052616.5.3.st.mn <- cellStats(ndvi052616.5.3.st, min)
ndvi052616.5.3.st.sd <- sd(ndvi052616.5.3.df$NDVI, na.rm = TRUE)

ndvi062316.5.3.st.av <- cellStats(ndvi062316.5.3.st, mean)
ndvi062316.5.3.st.md <- cellStats(ndvi062316.5.3.st, median)
ndvi062316.5.3.st.mx <- cellStats(ndvi062316.5.3.st, max)
ndvi062316.5.3.st.mn <- cellStats(ndvi062316.5.3.st, min)
ndvi062316.5.3.st.sd <- sd(ndvi062316.5.3.df$NDVI, na.rm = TRUE)

ndvi062916.5.3.st.av <- cellStats(ndvi062916.5.3.st, mean)
ndvi062916.5.3.st.md <- cellStats(ndvi062916.5.3.st, median)
ndvi062916.5.3.st.mx <- cellStats(ndvi062916.5.3.st, max)
ndvi062916.5.3.st.mn <- cellStats(ndvi062916.5.3.st, min)
ndvi062916.5.3.st.sd <- sd(ndvi062916.5.3.df$NDVI, na.rm = TRUE)

ndvi072716.5.3.st.av <- cellStats(ndvi072716.5.3.st, mean)
ndvi072716.5.3.st.md <- cellStats(ndvi072716.5.3.st, median)
ndvi072716.5.3.st.mx <- cellStats(ndvi072716.5.3.st, max)
ndvi072716.5.3.st.mn <- cellStats(ndvi072716.5.3.st, min)
ndvi072716.5.3.st.sd <- sd(ndvi072716.5.3.df$NDVI, na.rm = TRUE)

ndvi081716.5.3.st.av <- cellStats(ndvi081716.5.3.st, mean)
ndvi081716.5.3.st.md <- cellStats(ndvi081716.5.3.st, median)
ndvi081716.5.3.st.mx <- cellStats(ndvi081716.5.3.st, max)
ndvi081716.5.3.st.mn <- cellStats(ndvi081716.5.3.st, min)
ndvi081716.5.3.st.sd <- sd(ndvi081716.5.3.df$NDVI, na.rm = TRUE)

ndvi082416.5.3.st.av <- cellStats(ndvi082416.5.3.st, mean)
ndvi082416.5.3.st.md <- cellStats(ndvi082416.5.3.st, median)
ndvi082416.5.3.st.mx <- cellStats(ndvi082416.5.3.st, max)
ndvi082416.5.3.st.mn <- cellStats(ndvi082416.5.3.st, min)
ndvi082416.5.3.st.sd <- sd(ndvi082416.5.3.df$NDVI, na.rm = TRUE)

ndviav <- data.frame(Average = c(ndvi050316.5.3.st.av, ndvi052616.5.3.st.av, ndvi062316.5.3.st.av, ndvi062916.5.3.st.av,
                                 ndvi072716.5.3.st.av, ndvi081716.5.3.st.av, ndvi082416.5.3.st.av))

ndvimd <- data.frame(Median = c(ndvi050316.5.3.st.md, ndvi052616.5.3.st.md, ndvi062316.5.3.st.md, ndvi062916.5.3.st.md,
                                ndvi072716.5.3.st.md, ndvi081716.5.3.st.md, ndvi082416.5.3.st.md))

ndvisd <- data.frame(StandardDeviation = c(ndvi050316.5.3.st.sd, ndvi052616.5.3.st.sd, ndvi062316.5.3.st.sd, ndvi062916.5.3.st.sd,
                                           ndvi072716.5.3.st.sd, ndvi081716.5.3.st.sd, ndvi082416.5.3.st.sd))

ndvimx <- data.frame(Maximum = c(ndvi050316.5.3.st.mx, ndvi052616.5.3.st.mx, ndvi062316.5.3.st.mx, ndvi062916.5.3.st.mx,
                                 ndvi072716.5.3.st.mx, ndvi081716.5.3.st.mx, ndvi082416.5.3.st.mx))

ndvimn <- data.frame(Minimum = c(ndvi050316.5.3.st.mn, ndvi052616.5.3.st.mn, ndvi062316.5.3.st.mn, ndvi062916.5.3.st.mn,
                                 ndvi072716.5.3.st.mn, ndvi081716.5.3.st.mn, ndvi082416.5.3.st.mn))
...
rrbldf <- cbind(rrbldf, ndvimx)
rrbldf <- cbind(rrbldf, ndvimn)
write.csv(rrbldf, "RushRanchBlk1_2016.3.5.csv")

options(device = "RStudioGD")
ndvi050316.5.3.us <- unstack(ndvi050316.5.3.df); colnames(ndvi050316.5.3.us) <- "NDVI"
ndvi052616.5.3.us <- unstack(ndvi052616.5.3.df); colnames(ndvi052616.5.3.us) <- "NDVI"
ndvi062316.5.3.us <- unstack(ndvi062316.5.3.df); colnames(ndvi062316.5.3.us) <- "NDVI"
ndvi062916.5.3.us <- unstack(ndvi062916.5.3.df); colnames(ndvi062916.5.3.us) <- "NDVI"
ndvi072716.5.3.us <- unstack(ndvi072716.5.3.df); colnames(ndvi072716.5.3.us) <- "NDVI"
ndvi081716.5.3.us <- unstack(ndvi081716.5.3.df); colnames(ndvi081716.5.3.us) <- "NDVI"
ndvi082416.5.3.us <- unstack(ndvi082416.5.3.df); colnames(ndvi082416.5.3.us) <- "NDVI"

ndvi050316.5.3.p <- ggplot(ndvi050316.5.3.us, aes(ndvi050316.5.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi050316.5.3.p <- ndvi050316.5.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi050316.5.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi050316.5.3.p <- ndvi050316.5.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi050316.5.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi050316.5.3.p <- ndvi050316.5.3.p + labs(title = "Rush Ranch Block 1, Section 3.5\nMay 3, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi050316.5.3.p
ggsave(file = "050316.3.5.png")

ndvi052616.5.3.p <- ggplot(ndvi052616.5.3.us, aes(ndvi052616.5.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi052616.5.3.p <- ndvi052616.5.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi052616.5.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi052616.5.3.p <- ndvi052616.5.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi052616.5.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi052616.5.3.p <- ndvi052616.5.3.p + labs(title = "Rush Ranch Block 1, Section 3.5\nMay 26, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi052616.5.3.p
ggsave(file = "052616.3.5.png")

ndvi062316.5.3.p <- ggplot(ndvi062316.5.3.us, aes(ndvi062316.5.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi062316.5.3.p <- ndvi062316.5.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi062316.5.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi062316.5.3.p <- ndvi062316.5.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi062316.5.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi062316.5.3.p <- ndvi062316.5.3.p + labs(title = "Rush Ranch Block 1, Section 3.5\nJune 23, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062316.5.3.p
ggsave(file = "062316.3.5.png")

ndvi062916.5.3.p <- ggplot(ndvi062916.5.3.us, aes(ndvi062916.5.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi062916.5.3.p <- ndvi062916.5.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi062916.5.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi062916.5.3.p <- ndvi062916.5.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi062916.5.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi062916.5.3.p <- ndvi062916.5.3.p + labs(title = "Rush Ranch Block 1, Section 3.5\nJune 29, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi062916.5.3.p
ggsave(file = "062916.3.5.png")

ndvi072716.5.3.p <- ggplot(ndvi072716.5.3.us, aes(ndvi072716.5.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi072716.5.3.p <- ndvi072716.5.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi072716.5.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi072716.5.3.p <- ndvi072716.5.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi072716.5.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi072716.5.3.p <- ndvi072716.5.3.p + labs(title = "Rush Ranch Block 1, Section 3.5\nJuly 27, 2016 NDVI Values Histogram\n with mean &median", x = "")
ndvi072716.5.3.p
ggsave(file = "072716.3.5.png")

ndvi081716.5.3.p <- ggplot(ndvi081716.5.3.us, aes(ndvi081716.5.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi081716.5.3.p <- ndvi081716.5.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi081716.5.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi081716.5.3.p <- ndvi081716.5.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi081716.5.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi081716.5.3.p <- ndvi081716.5.3.p + labs(title = "Rush Ranch Block 1, Section 3.5\nAugust 17, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi081716.5.3.p
ggsave(file = "081716.3.5.png")

ndvi082416.5.3.p <- ggplot(ndvi082416.5.3.us, aes(ndvi082416.5.3.us$NDVI)) + geom_histogram(binwidth = 2, color = "white", fill = "darkblue")
ndvi082416.5.3.p <- ndvi082416.5.3.p + theme_bw() + geom_vline(aes(xintercept = median(ndvi082416.5.3.us$NDVI, na.rm = T)), color = "#b2df8a")
ndvi082416.5.3.p <- ndvi082416.5.3.p + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(aes(xintercept = mean(ndvi082416.5.3.us$NDVI, na.rm = T)), color = "#fc8d62")
ndvi082416.5.3.p <- ndvi082416.5.3.p + labs(title = "Rush Ranch Block 1, Section 3.5\nAugust 24, 2016 NDVI Values Histogram\n with mean & median", x = "")
ndvi082416.5.3.p
ggsave(file = "082416.3.5.png")

set.seed(131)
ndvi050316.5.3.us <- na.omit(ndvi050316.5.3.us); ndvi050316.5.3.rs <- sample_n(ndvi050316.5.3.us, 15000); ndvi050316.5.3.rs$Date <- "a"
ndvi052616.5.3.us <- na.omit(ndvi052616.5.3.us); ndvi052616.5.3.rs <- sample_n(ndvi052616.5.3.us, 15000); ndvi052616.5.3.rs$Date <- "b"
ndvi062316.5.3.us <- na.omit(ndvi062316.5.3.us); ndvi062316.5.3.rs <- sample_n(ndvi062316.5.3.us, 15000); ndvi062316.5.3.rs$Date <- "c"
ndvi062916.5.3.us <- na.omit(ndvi062916.5.3.us); ndvi062916.5.3.rs <- sample_n(ndvi062916.5.3.us, 15000); ndvi062916.5.3.rs$Date <- "d"
ndvi072716.5.3.us <- na.omit(ndvi072716.5.3.us); ndvi072716.5.3.rs <- sample_n(ndvi072716.5.3.us, 15000); ndvi072716.5.3.rs$Date <- "e"
ndvi081716.5.3.us <- na.omit(ndvi081716.5.3.us); ndvi081716.5.3.rs <- sample_n(ndvi081716.5.3.us, 15000); ndvi081716.5.3.rs$Date <- "f"
ndvi082416.5.3.us <- na.omit(ndvi082416.5.3.us); ndvi082416.5.3.rs <- sample_n(ndvi082416.5.3.us, 15000); ndvi082416.5.3.rs$Date <- "g"

rrblrs <- rbind(ndvi082416.5.3.rs, ndvi081716.5.3.rs)
rrblrs <- rbind(rrblrs, ndvi072716.5.3.rs)
rrblrs <- rbind(rrblrs, ndvi062916.5.3.rs)
rrblrs <- rbind(rrblrs, ndvi062316.5.3.rs)
rrblrs <- rbind(rrblrs, ndvi052616.5.3.rs)
rrblrs <- rbind(rrblrs, ndvi050316.5.3.rs)
...
rrblrsp <- rrblrsp + xlab("") + theme_bw()+ theme(axis.text.x = element_blank()) + theme(plot.title = element_text(hjust = 0.5))
rrblrsp <- rrblrsp + stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="#bf812d")
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.5\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016violin.3.5.png")
...
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.5\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016box.3.5.png")

###########################################################################

ndvi050316.6.3 <- crop(ndvi050316, extent(ndvi050316, 400, 479, 401, 600))
ndvi052616.6.3 <- crop(ndvi052616, extent(ndvi052616, 400, 479, 401, 600))
ndvi062316.6.3 <- crop(ndvi062316, extent(ndvi062316, 400, 479, 401, 600))
ndvi062916.6.3 <- crop(ndvi062916, extent(ndvi062916, 400, 479, 401, 600))
ndvi072716.6.3 <- crop(ndvi072716, extent(ndvi072716, 400, 479, 401, 600))
ndvi081716.6.3 <- crop(ndvi081716, extent(ndvi081716, 400, 479, 401, 600))
ndvi082416.6.3 <- crop(ndvi082416, extent(ndvi082416, 400, 479, 401, 600))
...
ndvi062316.6.3.st.av <- cellStats(ndvi062316.6.3.st, mean)
ndvi062316.6.3.st.md <- cellStats(ndvi062316.6.3.st, median)
...
ndvi050316.7.3 <- crop(ndvi050316, extent(ndvi050316, 480, 559, 401, 600))
ndvi052616.7.3 <- crop(ndvi052616, extent(ndvi052616, 480, 559, 401, 600))
ndvi062316.7.3 <- crop(ndvi062316, extent(ndvi062316, 480, 559, 401, 600))
ndvi062916.7.3 <- crop(ndvi062916, extent(ndvi062916, 480, 559, 401, 600))
ndvi072716.7.3 <- crop(ndvi072716, extent(ndvi072716, 480, 559, 401, 600))
ndvi081716.7.3 <- crop(ndvi081716, extent(ndvi081716, 480, 559, 401, 600))
ndvi082416.7.3 <- crop(ndvi082416, extent(ndvi082416, 480, 559, 401, 600))
...
ndvi062316.7.3.st.av <- cellStats(ndvi062316.7.3.st, mean)
ndvi062316.7.3.st.md <- cellStats(ndvi062316.7.3.st, median)
...
ndvi050316.8.3 <- crop(ndvi050316, extent(ndvi050316, 560, 639, 401, 600))
ndvi052616.8.3 <- crop(ndvi052616, extent(ndvi052616, 560, 639, 401, 600))
ndvi062316.8.3 <- crop(ndvi062316, extent(ndvi062316, 560, 639, 401, 600))
ndvi062916.8.3 <- crop(ndvi062916, extent(ndvi062916, 560, 639, 401, 600))
ndvi072716.8.3 <- crop(ndvi072716, extent(ndvi072716, 560, 639, 401, 600))
ndvi081716.8.3 <- crop(ndvi081716, extent(ndvi081716, 560, 639, 401, 600))
ndvi082416.8.3 <- crop(ndvi082416, extent(ndvi082416, 560, 639, 401, 600))
...
ndvi062316.8.3.st.av <- cellStats(ndvi062316.8.3.st, mean)
ndvi062316.8.3.st.md <- cellStats(ndvi062316.8.3.st, median)
...
ndvi050316.9.3 <- crop(ndvi050316, extent(ndvi050316, 640, 719, 401, 600))
ndvi052616.9.3 <- crop(ndvi052616, extent(ndvi052616, 640, 719, 401, 600))
ndvi062316.9.3 <- crop(ndvi062316, extent(ndvi062316, 640, 719, 401, 600))
ndvi062916.9.3 <- crop(ndvi062916, extent(ndvi062916, 640, 719, 401, 600))
ndvi072716.9.3 <- crop(ndvi072716, extent(ndvi072716, 640, 719, 401, 600))
ndvi081716.9.3 <- crop(ndvi081716, extent(ndvi081716, 640, 719, 401, 600))
ndvi082416.9.3 <- crop(ndvi082416, extent(ndvi082416, 640, 719, 401, 600))
...
ndvi062316.9.3.st.av <- cellStats(ndvi062316.9.3.st, mean)
ndvi062316.9.3.st.md <- cellStats(ndvi062316.9.3.st, median)
...
ndvi050316.10.3 <- crop(ndvi050316, extent(ndvi050316, 720, 798, 401, 600))
ndvi052616.10.3 <- crop(ndvi052616, extent(ndvi052616, 720, 798, 401, 600))
ndvi062316.10.3 <- crop(ndvi062316, extent(ndvi062316, 720, 795, 401, 600))
ndvi062916.10.3 <- crop(ndvi062916, extent(ndvi062916, 720, 771, 401, 600))
ndvi072716.10.3 <- crop(ndvi072716, extent(ndvi072716, 720, 766, 401, 600))
ndvi081716.10.3 <- crop(ndvi081716, extent(ndvi081716, 720, 771, 401, 600))
ndvi082416.10.3 <- crop(ndvi082416, extent(ndvi082416, 720, 790, 401, 600))
...
ndvi062316.10.3.st.av <- cellStats(ndvi062316.10.3.st, mean)
ndvi062316.10.3.st.md <- cellStats(ndvi062316.10.3.st, median)
...
rrbldf <- cbind(rrbldf, ndvimx)
rrbldf <- cbind(rrbldf, ndvimn)
write.csv(rrbldf, "RushRanchBlk1_2016.3.10.csv")
...
rrblrsp
ggsave(file = "rrblrsp2016violin.3.10.png")
...
rrblrsp <- rrblrsp + labs(title = "Rush Ranch Block 1, Section 3.10\n2016 NDVI Values")
rrblrsp
ggsave(file = "rrblrsp2016box.3.10.png")
